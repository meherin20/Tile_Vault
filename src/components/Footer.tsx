...
export default function Footer() {
  return (
    <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10 mt-auto">
      <aside>
        <p className="text-2xl font-bold">🧱 TileVault</p>
        <p className="text-sm opacity-80">
          Discover premium tiles for every aesthetic.
          <br />
          Crafting beautiful spaces since 2024.
        </p>
      </aside>
      ...
      <nav>
        ...
        <a className="link link-hover" href="mailto:hello@tilevault.com">hello@tilevault.com</a>
        <a className="link link-hover" href="tel:+1234567890">+1 (234) 567-890</a>
        <p className="text-sm opacity-70">123 Tile Street, Design City</p>
      </nav>
